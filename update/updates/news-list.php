...
<style type="text/css" >
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-30241550-1']);
    ...
    if ($i == 0) {
       ...
       // echo $members[$i][0];
		 ...
		 echo"     <tr>
                                ...
                                <td>
                                    <span class='text' style='display:inline;'><strong>".$members[$i][1]." <a href='http://dl.acm.org/citation.cfm?id=2425333'>ACM Digital Library</a>.</strong></span> 
                                </td>
                            </tr>";
